...
JHtml::_('formbehavior.chosen', '.multipleUsers',null,array('placeholder_text_multiple' => JText::_('COM_OKEYDOC_OPTION_SELECT_USER')));
...
?>
  ...
  <?php else : ?>
	...
	<th width="1%" class="nowrap hidden-phone">
	  <?php echo JHtml::_('searchtools.sort', 'JGLOBAL_HITS', 'd.hits', $listDirn, $listOrder); ?>
	</th>
	<th width="1%" class="nowrap hidden-phone">
	<?php echo JHtml::_('searchtools.sort', 'JGRID_HEADING_ID', 'd.id', $listDirn, $listOrder); ?>
      ...
      $canCreate = $user->authorise('core.create', 'com_okeydoc.category.'.$item->catid);
      ...
      $canChange = ($user->authorise('core.edit.state','com_okeydoc.document.'.$item->id) && $canCheckin); 
      ?>
	...
	<td class="order nowrap center hidden-phone">
	  ...
	  <td class="has-context">
		...
		<a href="<?php echo JRoute::_('index.php?option=com_okeydoc&task=document.edit&id='.$item->id);?>" title="<?php echo JText::_('JACTION_EDIT'); ?>"><?php echo $this->escape($item->title); ?></a>
	      <?php else : ?>
