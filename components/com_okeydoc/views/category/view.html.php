...
class OkeydocViewCategory extends JViewCategory
{
  ...
  public function display($tpl = null)
  {
	...
	$this->intro_items = OkeydocHelperQuery::orderDownColumns($this->intro_items, $this->columns);
      }
    }
    ...
    $this->filterForm->loadFile(JPATH_SITE.'/components/com_okeydoc/models/forms/filter_category.xml');
